  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <MetricCard label="Anotações salvas" value={String(data.totalNotes)} helper="Conhecimentos prontos para consulta" tone="sky" />
        <MetricCard label="Áreas ativas" value={String(data.usedAreas)} helper={`${data.usedCategories} categorias organizadas`} tone="emerald" />
        <MetricCard label="Favoritos" value={String(favoriteCount)} helper="Conteúdos importantes em destaque" tone="rose" />
      </section>
